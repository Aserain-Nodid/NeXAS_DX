...
public class CCpuEventMove extends CCpuEvent {
    ...
    public static final CCpuEventMoveType[] CCPU_EVENT_MOVE_TYPES = {
            ...
            new CCpuEventMoveType(0xFFFFFFFF, "指定位置時Ｘ"), // diff
            new CCpuEventMoveType(0xFFFFFFFF, "指定位置時Ｙ"), // diff
    ...
    private Integer positionX; // diff
    private Integer positionY; // diff
    ...
    public void readInfo(BinaryReader reader) {
        ...
        this.positionX = reader.readInt(); // diff
        this.positionY = reader.readInt(); // diff
    ...
    public void writeInfo(BinaryWriter writer) throws IOException {
        ...
        writer.writeInt(this.positionX); // diff
        writer.writeInt(this.positionY); // diff
